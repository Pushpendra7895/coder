...
$mail->Username = 'psharma1832000@gmail.com';    // SMTP username
$mail->Password = 'rdjgcnnoqyptoigu'; // SMTP password
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to
$mail->setFrom('psharma1832000@gmail.com','Pushpendra Sharma');
